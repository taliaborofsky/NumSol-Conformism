...
plotMU + scale_color_viridis() #scale_colour_manual(values = cols) #scale_color_brewer(palette="viridis") #+ scale_colour_manual(values = c("darkred","red","orange","yellow", "green","blue","darkblue"))
